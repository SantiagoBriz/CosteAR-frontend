import { usePendingProposals, useApproveProposalMutation, useRejectProposalMutation, useRunNightlyPipelineMutation } from '../admin-hooks';
import { Card } from '@/components/ui/Card';
import { Button } from '@/components/ui/Button';
import { Loader2, CheckCircle2, XCircle, FileText, AlertTriangle, Zap } from 'lucide-react';
              ...
              {proposal.requiresVerification && (
                <div className="flex items-start gap-2 text-sm text-amber-800 bg-amber-50 border border-amber-200 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    Este texto lo redactó la IA sin una corrección real de un costista de base — no está garantizado que sea correcto. Verificá el contenido antes de aprobar.
                  </div>
                </div>
              )}
              <div>
